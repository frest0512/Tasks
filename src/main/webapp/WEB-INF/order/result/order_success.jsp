...
<div class="banner-top">
    <div class="container">
        ...
        <h3 class="animated wow fadeInRight" data-wow-delay=".5s"><a
                href="<c:url value="/"/>">Home</a><label>/</label>Order<label>/</label>Success</h3>
    ...
    <div class="container">
        <div class="product">
            <div class="container" align="center">
                <h1><fmt:message key="status.make.order.success"/></h1>
                <h2><fmt:message key="status.make.order.success.description"/></h2>
                <div class="clearfix"/>
            </div>
        </div>
    </div>
