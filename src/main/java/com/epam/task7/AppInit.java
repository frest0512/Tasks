...
import com.epam.task7.readers.CarReflectReader;
import com.epam.task7.readers.HelicopterReflectReader;
...
public class AppInit {
    ...
    public HashMap<String, Command> initAll(Storage storage, Scanner scanner) {
    ...
    public String getCommandsListAsString() {
    ...
    public ReaderContainer initReadContainer(Scanner scanner) {
        Locale locale = new Locale("ru", "RU");
        ResourceBundle resourceBundle = ResourceBundle.getBundle("field", locale);
        ...
        readerContainer.add("car", new CarReflectReader(resourceBundle, myScanner));
        readerContainer.add("helicopter", new HelicopterReflectReader(resourceBundle, myScanner));
